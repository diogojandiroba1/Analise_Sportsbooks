...
def hiper():
    try:
        ...
        with open(r'data\\jsonCasas\\dataHiper.json', 'r', encoding='utf-8') as f:
            data = json.load(f)
            ...
            try:
                ...
                for btg in partida['btgs']:
                    for fo in btg['fos']:
                        aposta = fo['btN']
                        odd = fo['hO']
                        dados.append(['HiperBet', nome_partida, aposta, odd, dataatual, 'https://m.hiper.bet.br/ptb/bet/anteposts/super-odds-multi-specials-/soccer/super-odds'])
